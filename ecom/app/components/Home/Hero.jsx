      ...
      <div className="relative z-10 mx-auto max-w-3xl text-center ">
        ...
        <div className="mt-8">
          <Link
            ...
            target="_blank"
            className="group inline-flex items-center gap-3 rounded-full bg-[#25D366] px-5 py-2 text-lg font-bold text-white shadow-lg shadow-[#25D366]/40 transition-all duration-300 hover:shadow-xl hover:shadow-[#25D366]/60 hover:scale-105 active:scale-95"
          >
            <FaWhatsapp size={35} />
            Message For details 
          </Link>
