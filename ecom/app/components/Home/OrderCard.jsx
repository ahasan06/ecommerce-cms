    ...
    <section className="relative mx-auto max-w-xl px-4 md:mt-16">
      <div className="relative overflow-visible rounded-2xl border border-white/10 bg-gradient-to-br from-[#0d0e12] to-[#0a0a0a] p-5 md:p-8 shadow-[0_10px_30px_rgba(0,0,0,0.35)]">
        ...
        <div className="relative z-10 md:px-8 text-center flex flex-col items-center">
          ...
          <div className="mt-5">
            {/* Use <a> for mailto: instead of <Link> */}
            <Link
              href={`mailto:tubsense25@gmail.com?subject=${encodeURIComponent(
                "TubSense order inquiry"
              )}&body=${encodeURIComponent(
                "Hi TubSense team,\n\nI’m interested in ordering. Please share pricing, availability, and delivery options.\n\nThanks,"
              )}`}
              ...
              aria-label="Email TubSense to place an order"
            >
              Click Here
            </Link>
          </div>
